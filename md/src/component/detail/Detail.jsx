...
const Detail = () => {
    return (
        <>
            <div className="svg"><svg width="97vw" height="80vh" className='svgi' viewBox="0 -77.7 373.856 373.856" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='detail' id='detail'>
                <div className="ldetail">
                    ...
                    <h2>Classic Interiors & Exteriors</h2>
                    <p>MD is the pioneer of innovative edifices featuring reputed construction sites in Surat, Ahmedabad, Navsari, Bardoli, Amreli and Vapi. Right from the inception in Amreli, our gigantic residential projects along with some ultra-modern commercial spaces have been the talk of the town.</p>
                    <a href="https://wa.me/7990152659?text=hello%2C%20I%20wants%20to%20contact%20you..."> <div className="btn">Contact Us</div></a>
                </div>
                ...
                <div className="rdetail">
                    <div className="info">
                        ...
                        <h4>Residential</h4>
                        <p>Residential Plots & Bungalows Project in Surat with Amenities Like World-class Club House...</p>
                    </div>

                    <div className="info">
                        <GiWorld className='icon'></GiWorld>
                        <h4>Lifestyle Club</h4>
                        <p>MD Group Utopia is a paradise where nature retains its purity, its originality and its freshness...

                        </p>
                    </div>

                    <div className="info">
                        <TiTick className='icon'></TiTick>
                        <h4>Commercial
                        </h4>
                        <p>MD Group is the newest premium shopping hub of surat, brought to you by the veteran MD Group..</p>
                    </div>

                    <div className="info">
                        <TbDiamond className='icon'></TbDiamond>                    <h4>Supreme Location
                        </h4>
                        <p>Tasteful and seem-less renovation, this home is a unique refreshing.
